...
tags: ["cybersecurity", "security", "resources"]
type: "article"
---
...
* *Anomaly:Body \- Large* with Rule ID *ee922cf00077462d9f2f7330b114b839* (Rule [*100048*](https://developers.cloudflare.com/waf/reference/legacy/old-waf-managed-rules/\#important-remarks)), in order to mitigate body payloads which are higher than the [processing limit](https://developers.cloudflare.com/ruleset-engine/rules-language/fields/\#http-request-body-fields).   
...
If you have employee portals or extranets, restrict access to countries in which you have employees located, or preferably opt for a [Zero Trust approach](https://developers.cloudflare.com/learning-paths/zero-trust-web-access/).
